...
<div class="content-wrapper">
    ...
    <section class="content">
        <form method="post" action="{{ route('update',$data->id) }}" class="form-horizontal form-label-left input_mask" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" name="text1" value="{{$data->text1}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Text2</label>
                                <input type="text" id="inputName" name="text2" value="{{$data->text2}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Text3</label>
                                <input type="text" id="inputName" name="text3" value="{{$data->text3}}" class="form-control">
                            </div>
                            <div class="form-group">
    ...
    <!-- Main content -->
    <section class="content">
        <form method="get" action="{{ route('seo_sayfa_update',$data->id) }}" class="form-horizontal form-label-left input_mask">
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" name="title" value="{{$data->title}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Description</label>
                                <input type="text" id="inputName" name="desc" value="{{$data->desc}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <a href="#" class="btn btn-secondary">Vazgeç</a>
                                <input type="submit" value="Güncelle" class="btn btn-success">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div style="display: block;height: 150px;overflow: overlay;">
                                                    <img style="width:100%" class="img-fluid" src="<?= url("uploads"); ?>/<?= $row->dosya; ?>" />
                                                </div>
                                                <a href="<?= url("panel/resmi_sil"); ?>/<?= $row->id; ?>" style="display: flex;margin-top:5px" class="btn btn-danger btn-sm">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="file" name="dosya" id="inputName" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
